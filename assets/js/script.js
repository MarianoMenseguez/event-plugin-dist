/**
 * JavaScript del plugin Event Calendar Plugin
 */
...
(function ($) {
  ...
  var ECP = {
    ...
    showRegistrationForm: function (e) {
      ...
      setTimeout(function () {
        const formHtml = ECP.generateRegistrationForm(eventId);
